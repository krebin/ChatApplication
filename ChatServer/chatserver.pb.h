...
class HelloRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:chatserver.HelloRequest) */ {
 public:
  HelloRequest();
  ...
  // @@protoc_insertion_point(class_scope:chatserver.HelloRequest)
 private:
...
class HelloReply : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:chatserver.HelloReply) */ {
 public:
  HelloReply();
  virtual ~HelloReply();
  ...
  // @@protoc_insertion_point(class_scope:chatserver.HelloReply)
 private:
...
// optional string messages = 1;
inline void HelloReply::clear_messages() {
  messages_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& HelloReply::messages() const {
...
inline void HelloReply::set_messages(const ::std::string& value) {
...
inline void HelloReply::set_messages(const char* value) {
...
inline void HelloReply::set_messages(const char* value, size_t size) {
...
inline ::std::string* HelloReply::mutable_messages() {
...
inline ::std::string* HelloReply::release_messages() {
...
inline void HelloReply::set_allocated_messages(::std::string* messages) {
  if (messages != NULL) {
